...
const baseParse = _ => {
    ...
    d.push({
        desc: '48 && float',
        url: 'file:///storage/emulated/0/Android/data/com.example.hikerview/files/Documents/TyrantG/public/douyu-tabs.html?title='+MY_RULE.title+'&time='+(new Date()).getTime(),

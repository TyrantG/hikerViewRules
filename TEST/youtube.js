...
const secParse = params => {
    ...
    let res_json = fetch('https://s6.save.tube/ajax/getLinks.php?video='+encodeURIComponent(ori_url)+'&rand=xCAasG22rQg2XeV', {headers:{'User-Agent': 'Mozilla/5.0 (Windows NT 10.0)'}})
    log(res_json)
